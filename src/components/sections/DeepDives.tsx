      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-4 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-mono text-amber-400 bg-amber-500/10 border border-amber-500/20">
            ...
            <span>TECHNICAL WRITE-UPS & NOTES</span>
          </div>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800/80 pb-4">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-mono text-amber-300 bg-amber-950/60 border border-amber-800/80 hover:bg-amber-900/80 transition-all shrink-0 cursor-pointer"
                  >
                ...
                <div className="flex flex-wrap items-center gap-2 pt-2">
                  {note.tags.map((t) => (
                    <span
                      key={t}
                      className="px-2.5 py-1 rounded text-[11px] font-mono text-amber-300 bg-amber-950/40 border border-amber-900/60"
                    >
                      {t}
                    </span>
                  ))}
